...
namespace AccesoDatos
{
    public class LogSocioNegocio
    {
        public void agregar(string Accion, string tabla, int idRegistro, string nombre, string nombreUsuario, string comentario)
        {
            ...
            try
            {
                accesoDatos.setearConsulta("INSERT INTO LogSocio (Accion, Tabla, IdRegistro, NombreRegistro, Usuario, Descripcion) VALUES (@Accion, @Tabla, @IdRegistro, @NombreRegistro, @Usuario, @Descripcion); ");
        ...
        public List<LogActividad> ListarLogs()
        {
            ...
            try
            {
                ...
                accesoDatos.setearConsulta("SELECT IdLog, Accion, Tabla, IdRegistro, NombreRegistro, Usuario, Descripcion, Fecha FROM LogSocio");
