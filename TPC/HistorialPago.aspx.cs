...
namespace TPC
{
    public partial class HistorialPago : System.Web.UI.Page
    {
        ...
        private void CargarPagos(int idSocio)
        {
            ...
            if (idSocio == 1)
            {
                dt.Rows.Add(1, new DateTime(2025, 10, 1), 15000);
                dt.Rows.Add(2, new DateTime(2025, 9, 1), 15000);
            }
            else if (idSocio == 2)
            {
                dt.Rows.Add(3, new DateTime(2025, 10, 5), 12000);
            }
            else
            {
                dt.Rows.Add(4, new DateTime(2025, 11, 1), 10000);
            }
